...
```{r}
# List the species originally analyzed in the taxonomic regionalization paper (Pata et al. 2022)
...
# 4. Export files
```{r}
# taxalist.dfo.database <- taxalist # Also export the taxonomy table for converting species-stage names to the curated regionalization species names
...
#      file = here("data/restricted_data/zoop_data_regionalized_annotated_20231018.RData"))
