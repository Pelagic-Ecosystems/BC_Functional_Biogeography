...
# get_legend() is not working properly in ggplot2 v.3.5.0. This is an open issue (https://github.com/wilkelab/cowplot/issues/202). For now, the legend needs to be annotated from the previous version of this figure generate in an earlier ggplot2 version.
