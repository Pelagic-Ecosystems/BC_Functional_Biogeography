...
## FigS5 Species density in trait space
...
ggsave(filename = here("figures/fig_S5_traits_space_ab_PC12.png"),
    width = 10, height= 12, units = "in", dpi = 600, bg = "white")
```


# 4. Table S2 Bioregion composition comparisons
```{r}
...
#           file = here("tables/table_S2_bioregion_fg_means_to_annotate_20240704.csv"), row.names = FALSE)
